...
REGISTERED_NORM_DICT: Dict[str, Type[nn.Module]] = {
    "bn2d": nn.BatchNorm2d,
    "ln": nn.LayerNorm,
    "ln2d": LayerNorm2d,  # Make sure LayerNorm2d is imported correctly
}
...
def reset_bn(
    ...
    from fastervit.apps.utils import AverageMeter, is_master, sync_tensor
    from fastervit.efficientvit.utils import get_device, list_join
